...
Declare MinMax Cursor For Select Column_Name,Case When Is_Nullable='NO' Then '0' Else '1' End From Hospital.Information_Schema.Columns 
	Where Column_Name Not In ('encounterid') 
		And Columns.DATA_TYPE In ('Float','Int','TinyInt','SmallInt') 
